...
const {adminRegister,register,login,logout,getProfile,getUserStats,getUserSubmissions}=require('../controllers/userAuth');
...
authRouter.get('/submissions',userMiddleware,getUserSubmissions);
